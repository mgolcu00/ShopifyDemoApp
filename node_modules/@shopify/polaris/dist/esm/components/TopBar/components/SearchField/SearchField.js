...
function SearchField({
  ...
  var clearMarkup = value !== '' && /*#__PURE__*/React$1.createElement("button", {
    type: "button",
  ...
  var className = classNames(styles.SearchField, (focused || active || forceActive) && styles.focused, newDesignLanguage && styles['SearchField-newDesignLanguage']);

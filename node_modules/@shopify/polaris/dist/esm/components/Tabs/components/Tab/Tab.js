...
function Tab({
  ...
  var tabContainerClassNames = classNames(styles.TabContainer, selected && styles.Underline, newDesignLanguage && styles.newDesignLanguage);
  var tabTitleClassNames = classNames(styles.Title, newDesignLanguage && styles.newDesignLanguage);

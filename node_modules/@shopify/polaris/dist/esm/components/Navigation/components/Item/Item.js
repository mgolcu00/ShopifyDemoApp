...
function Item({
  ...
  var indicatorMarkup = hasNewChild ? /*#__PURE__*/React$1.createElement("span", {
    className: styles.Indicator
  }, _ref) : null;
  var iconMarkup = icon ? /*#__PURE__*/React$1.createElement("div", {
  ...
  var wrappedBadgeMarkup = badgeMarkup == null ? null : /*#__PURE__*/React$1.createElement("div", {
    className: styles.Badge
  }, badgeMarkup);
  var itemContentMarkup = /*#__PURE__*/React$1.createElement(React$1.Fragment, null, iconMarkup, /*#__PURE__*/React$1.createElement("span", {
    className: styles.Text
  }, label, indicatorMarkup), wrappedBadgeMarkup);

  if (url == null) {
    var _className = classNames(styles.Item, disabled && styles['Item-disabled'], keyFocused && styles.keyFocused);
  ...
  var secondaryActionMarkup = secondaryAction && /*#__PURE__*/React$1.createElement(UnstyledLink$1, {
    external: true,
  ...
  var itemClassName = classNames(styles.Item, disabled && styles['Item-disabled'], selected && subNavigationItems.length === 0 && styles['Item-selected'], showExpanded && styles.subNavigationActive, keyFocused && styles.keyFocused);
  ...
  if (subNavigationItems.length > 0 && showExpanded) {
    ...
    var SecondaryNavigationClassName = classNames(styles.SecondaryNavigation, !icon && styles['SecondaryNavigation-noIcon']);
  ...
  var className = classNames(styles.ListItem, secondaryAction && styles['ListItem-hasAction']);
  return /*#__PURE__*/React$1.createElement("li", {
    className: className

...
function Avatar({
  ...
  var imageMarkUp = source && isAfterInitialMount && status !== Status.Errored ? /*#__PURE__*/React$1.createElement(Image$1, {
  ...
  var avatarBody = customer || !initials ? _ref : /*#__PURE__*/React$1.createElement("text", {
    x: "50%",
    y: "50%",
    dy: verticalOffset,
    fill: "currentColor",
  ...
  var svgMarkup = !hasImage ? /*#__PURE__*/React$1.createElement("span", {

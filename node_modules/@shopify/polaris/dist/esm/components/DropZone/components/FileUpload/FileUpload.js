...
function FileUpload(props) {
  ...
  var fileUploadClassName = classNames(styles.FileUpload, newDesignLanguage && styles.newDesignLanguage, measuring && styles.measuring, size === 'small' && styles.FileUploadSmallView);
  var viewMarkup;

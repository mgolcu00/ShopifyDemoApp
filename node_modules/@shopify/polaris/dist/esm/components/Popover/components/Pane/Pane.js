...
import { Section as Section$1 } from '../Section/Section.js';
...
function Pane({
  ...
  var className = classNames(styles.Pane, fixed && styles['Pane-fixed']);
  var content = sectioned ? wrapWithComponent(children, Section$1, {}) : children;
  return fixed ? /*#__PURE__*/React$1.createElement("div", {
    className: className
  }, content) : /*#__PURE__*/React$1.createElement(Scrollable$1, {
    hint: true,
    shadow: true,
    className: className,
